  ...
  <div class="page-container text-center">
    ...
    <div v-show="!isLoading" class="footer-container">
      ...
      <div class="footer-actions grid-row-2">
        ...
        <button-element @click="submitOffer">ยอมรับ</button-element>
      </div>
    </div>
    ...
    methods: {
      ...
      submitOffer () {
        ...
        const clmPackageData = [
          ...
          this.selectedPackage.offerName,
          this.selectedPackage.voice,
          this.selectedPackage.wifi,
        ]
        ...
        this.isLoading = true
        this.$store.dispatch(ORDER_NEW_PACKAGE, submitData)
          .then((data) => {
            this.isLoading = false
